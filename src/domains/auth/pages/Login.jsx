    ...
    <MobileFrame>
      <div className="login">
        ...
        <div className="login-actions">
          <button
            className="oauth oauth-kakao reveal"
            style={{ '--d': '80ms' }}
            disabled={pending}
            onClick={() => handleOAuth('kakao')}
          >
            <span className="oauth-ic">💬</span>
            {pending ? '연결 중...' : '카카오로 시작하기'}
          </button>
          <button
            className="oauth oauth-google reveal"
            style={{ '--d': '140ms' }}
            disabled={pending}
            onClick={() => handleOAuth('google')}
          >
            <span className="oauth-ic">🇬</span>
            {pending ? '연결 중...' : '구글로 시작하기'}
          </button>
        </div>
        ...
        <p className="login-terms reveal" style={{ '--d': '200ms' }}>
          로그인 시 바른인증식당의{' '}
          <a
            href="https://beaded-aunt-cf4.notion.site/3a9f7c49537680de991feab579b9f46c"
            target="_blank"
            rel="noreferrer"
          >
            이용약관
          ...
          및{' '}
          <a
            href="https://app.notion.com/p/3a8f7c4953768059a409ce14d13ae4ea"
            target="_blank"
            rel="noreferrer"
          >
            개인정보처리방침
